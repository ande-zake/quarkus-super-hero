...
source https://quarkus.io/blog/quarkus-superheroes-to-the-rescue/

Each of the services can also be run via Quarkus Dev Mode simultaneously. For each Quarkus service 
1. event-statistics
2. rest-fights
3. rest-heroes
4. rest-villains
...
Event statistics UI: http://localhost:8085
